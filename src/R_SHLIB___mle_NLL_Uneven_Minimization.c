...
/* The function conducts maximum likelihood estimation of colonization and
   ...
   R_SHLIB___mle_NLL_Uneven_Minimization(...)
   ...
   R_SHLIB___mle_NLL_Uneven_Minimization.so.
...
void R_SHLIB___mle_NLL_Uneven_Minimization( int * pNo_of_SPECIES, char ** Species_Tag,
  ...
  */
  ...
  for( i=0; i<No_of_SPECIES; i++ ) {
    Data[i] = (SP_Matrix_Data *)calloc( 1, sizeof(SP_Matrix_Data) );
		SP_Matrix_Data_Alloc( No_of_SITES[i], No_of_COLUMNS, No_of_COLUMNS,
		                      Data[i]) ;
